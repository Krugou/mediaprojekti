let map = L.map('map').setView([60.192059, 24.945831], 11);
let beachesData =[];
    ...
    //  console.log(beachesData[7]);
        for (let i=0; i<beachesData.length; i++) {
            ...
            //  console.log(beaches2.meta.name);
                ...
                marker.bindPopup(`<b>${beaches2.meta.name}<b><br><b>Ilman lampotila: ${beaches2.data[beaches2.data.length-1].temp_air}<br><b>Veden lampotila: ${beaches2.data[beaches2.data.length-1].temp_water}`);
            }
